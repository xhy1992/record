...
class Home extends Component {
	render() {
		...
		return (
			<div>
				<ListTodoMemos todolist={todolist} 
            	...
            	/>
            	<ListDoneMemos todolist={todolist}  onDoneToDoing={index=>dispatch(changeDoneToDoing(index))} onDel={index=>dispatch(deleteTodo(index))}/>
            </div>
		)
	}
